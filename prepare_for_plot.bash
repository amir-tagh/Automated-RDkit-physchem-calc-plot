...
#./prepare_for_plot.bash DEL_LIB.smi DEL_LIB-mol-desc.dat HITS.smi HITS-mol-desc.dat
...
#DEL HITS
echo "Now reading file1"
 echo "file1 is $file1"
  echo "file2 is $file2"
   ./RDkit_mol_desc_calc.py "$file1" > "$file2"

#DEL LIB
./RDkit_mol_desc_calc.py "$file3" > "$file4"
echo "Now reading file3"
 echo "file1 is $file3"
  echo "file4 is $file4"
 ...
 do	
  counter=$((counter+1))
   ...
   echo "counter is $counter"
    ...
    awk -v var=$var1  '{print $var}' $file2 > G4C2-all-lib-desc.dat
     awk -v var=$var1  '{print $var}' $file4 > G2C2_desc.dat
      #awk -v var=$var1  '{print $var}' INFORNA_mol_desc.dat > INFORNA_desc.dat

      sed -i "s/BBB/$f/g" violin_polt_QED.py

       ./violin_polt_QED.py G4C2-all-lib-desc.dat G2C2_desc.dat

         sed -i "s/$f/BBB/g" violin_polt_QED.py
done

#rm -rf Images_RDKIT
mkdir -p Images_RDKIT
mv *.png Images_RDKIT
